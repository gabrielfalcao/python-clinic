...
def test_s3_store_save(context):
    ...
    s3_tree().should.equal([
        'python-clinic-dao-prefix/offers/offer_id/757ba69fd154ee1ebdf54b3e3fd0a26de3e02db2',
    ])
...
def test_store_retrieve_by_key(context):
    ...
    s3_tree().should.equal([
        'python-clinic-dao-prefix/offers/offer_id/95513cb8dd373b33e6d3d72ec44950b660d89792',
    ])
